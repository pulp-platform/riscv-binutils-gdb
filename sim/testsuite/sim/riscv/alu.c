...
# output: == test: logic -> success, nr. of errors: 0\n
# output: == test: logic_imm -> success, nr. of errors: 0\n
# output: == test: shifts -> success, nr. of errors: 0\n
# output: == test: shifts_imm -> success, nr. of errors: 0\n
...
void check_shifts_imm (testresult_t *result, void (*start) (),
                       void (*stop) ());

testcase_t testcases[] = { { .name = "add", .test = check_add },
...
void
check_logic (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
...
void
check_logic_imm (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_shifts (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  uint32_t act;
...
void
check_shifts_imm (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
