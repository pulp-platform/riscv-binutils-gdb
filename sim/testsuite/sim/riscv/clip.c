...
testcase_t testcases[] = { { .name = "clip", .test = check_clip },
...
void
check_clip (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_clipu (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_clip_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_clipu_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
