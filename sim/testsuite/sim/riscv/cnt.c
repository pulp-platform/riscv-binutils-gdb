...
# output: == test: ff1 -> success, nr. of errors: 0\n
# output: == test: fl1 -> success, nr. of errors: 0\n
# output: == test: cnt -> success, nr. of errors: 0\n
# output: == test: clb -> success, nr. of errors: 0\n
...
//                                                                            //
//                                                                            //
// Revision: // Revision v0.1 - File Created //
//                                                                            //
//                                                                            //
//                                                                            //
//                                                                            //
...
testcase_t testcases[] = { { .name = "ff1", .test = check_ff1 },
...
void
check_ff1 (testresult_t *result, void (*start) (), void (*stop) ())
{
  uint32_t act;
  uint32_t exp;
  uint32_t a;
  ...
  a = 0x110110;
  asm volatile(FF1 " %[d], %[a]" : [d] "+r"(act) : [a] "r"(a));
...
void
check_fl1 (testresult_t *result, void (*start) (), void (*stop) ())
{
  uint32_t act;
  uint32_t exp;
  uint32_t a;
  ...
  a = 0x4FFFFFFF;
  asm volatile(FL1 " %[d], %[a]" : [d] "+r"(act) : [a] "r"(a));
...
void
check_cnt (testresult_t *result, void (*start) (), void (*stop) ())
{
  uint32_t act;
  uint32_t exp;
  uint32_t a;
  ...
  a = 0x10101010;
  asm volatile(CNT " %[d], %[a]" : [d] "+r"(act) : [a] "r"(a));
...
void
check_clb (testresult_t *result, void (*start) (), void (*stop) ())
{
  uint32_t act;
  uint32_t exp;
  uint32_t a;
  ...
  a = 0x7FFFFFFF;
  asm volatile(CLB " %[d], %[a]" : [d] "+r"(act) : [a] "r"(a));
