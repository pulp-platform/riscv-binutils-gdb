...
# output: == test: hwlp -> success, nr. of errors: 0\n
# output: == test: same_end -> success, nr. of errors: 0\n
# output: == test: csr -> success, nr. of errors: 0\n
...
testcase_t testcases[] = { { .name = "hwlp", .test = check_hwlp },
...
void
check_hwlp (testresult_t *result, void (*start) (), void (*stop) ())
{
...
void
check_same_end (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i, j;
...
void
check_csr (testresult_t *result, void (*start) (), void (*stop) ())
{
  ...
  asm volatile("csrw 0x800, %0" ::"r"(0xdeadbeef));
  asm volatile("csrw 0x801, %0" ::"r"(0xbeefdead));
  asm volatile("csrw 0x802, %0" ::"r"(0xabbadead));
  asm volatile("csrw 0x804, %0" ::"r"(0xdeadabba));
  asm volatile("csrw 0x805, %0" ::"r"(0xabbaabba));
  asm volatile("csrw 0x806, %0" ::"r"(0xbabbabab));

  asm volatile("csrr %0, 0x800" : "=r"(start0));
  asm volatile("csrr %0, 0x801" : "=r"(end0));
  asm volatile("csrr %0, 0x802" : "=r"(cnt0));
  asm volatile("csrr %0, 0x804" : "=r"(start1));
  asm volatile("csrr %0, 0x805" : "=r"(end1));
  asm volatile("csrr %0, 0x806" : "=r"(cnt1));
