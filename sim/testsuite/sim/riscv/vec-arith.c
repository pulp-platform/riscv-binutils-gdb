...
# output: == test: add -> success, nr. of errors: 0\n
# output: == test: sub -> success, nr. of errors: 0\n
# output: == test: avg -> success, nr. of errors: 0\n
# output: == test: abs -> success, nr. of errors: 0\n
# output: == test: ext -> success, nr. of errors: 0\n
# output: == test: extu -> success, nr. of errors: 0\n
# output: == test: ins -> success, nr. of errors: 0\n
...
testcase_t testcases[] = {
  { .name = "add", .test = check_add }, { .name = "sub", .test = check_sub },
  { .name = "avg", .test = check_avg }, { .name = "abs", .test = check_abs },
  { .name = "ext", .test = check_ext }, { .name = "extu", .test = check_extu },
  { .name = "ins", .test = check_ins }, { 0, 0 }
};
...
void
test_check (testresult_t *result, const char *asm_str, uint32_t act,
            uint32_t exp)
{
  if (act != exp)
    {
...
void
check_add (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_sub (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_avg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_abs (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_ext (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_extu (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_ins (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
  //-----------------------------------------------------------------
