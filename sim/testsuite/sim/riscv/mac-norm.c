...
# output: == test: mulsNl -> success, nr. of errors: 0\n
# output: == test: macsNl -> success, nr. of errors: 0\n
# output: == test: muluNl -> success, nr. of errors: 0\n
# output: == test: macuNl -> success, nr. of errors: 0\n
# output: == test: mulusNl -> success, nr. of errors: 0\n
# output: == test: macusNl -> success, nr. of errors: 0\n
# output: == test: mulsNr -> success, nr. of errors: 0\n
# output: == test: macsNr -> success, nr. of errors: 0\n
# output: == test: muluNr -> success, nr. of errors: 0\n
# output: == test: macuNr -> success, nr. of errors: 0\n
# output: == test: mulusNr -> success, nr. of errors: 0\n
# output: == test: macusNr -> success, nr. of errors: 0\n
# output: == test: mulsNrR -> success, nr. of errors: 0\n
# output: == test: macsNrR -> success, nr. of errors: 0\n
# output: == test: muluNrR -> success, nr. of errors: 0\n
# output: == test: macuNrR -> success, nr. of errors: 0\n
# output: == test: mulusNrR -> success, nr. of errors: 0\n
# output: == test: macusNrR -> success, nr. of errors: 0\n
...
testcase_t testcases[] = { { .name = "mulsNl", .test = check_mulsNl },
...
void
check_mulsNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULSNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulsNl_a[i]), [b] "r"(g_mulsNl_b[i]),
                     [imm] "i"(g_mulsNl_IMM));
...
void
check_muluNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_muluNl_a[i]), [b] "r"(g_muluNl_b[i]),
                     [imm] "i"(g_muluNl_IMM));
...
void
check_mulusNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUSNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulusNl_a[i]), [b] "r"(g_mulusNl_b[i]),
                     [imm] "i"(g_mulusNl_IMM));
...
void
check_mulsNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULSNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulsNr_a[i]), [b] "r"(g_mulsNr_b[i]),
                     [imm] "i"(g_mulsNr_IMM));
...
void
check_muluNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_muluNr_a[i]), [b] "r"(g_muluNr_b[i]),
                     [imm] "i"(g_muluNr_IMM));
...
void
check_mulusNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUSNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulusNr_a[i]), [b] "r"(g_mulusNr_b[i]),
                     [imm] "i"(g_mulusNr_IMM));
...
void
check_mulsNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULSNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulsNrR_a[i]), [b] "r"(g_mulsNrR_b[i]),
                     [imm] "i"(g_mulsNrR_IMM));
...
void
check_muluNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_muluNrR_a[i]), [b] "r"(g_muluNrR_b[i]),
                     [imm] "i"(g_muluNrR_IMM));
...
void
check_mulusNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MULUSNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "=r"(res)
                   : [a] "r"(g_mulusNrR_a[i]), [b] "r"(g_mulusNrR_b[i]),
                     [imm] "i"(g_mulusNrR_IMM));
...
void
check_macsNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACSNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macsNl_c[i])
                   : [a] "r"(g_macsNl_a[i]), [b] "r"(g_macsNl_b[i]),
                     [imm] "i"(g_macsNl_IMM));
...
void
check_macuNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macuNl_c[i])
                   : [a] "r"(g_macuNl_a[i]), [b] "r"(g_macuNl_b[i]),
                     [imm] "i"(g_macuNl_IMM));
...
void
check_macusNl (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUSNL " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macusNl_c[i])
                   : [a] "r"(g_macusNl_a[i]), [b] "r"(g_macusNl_b[i]),
                     [imm] "i"(g_macusNl_IMM));
...
void
check_macsNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACSNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macsNr_c[i])
                   : [a] "r"(g_macsNr_a[i]), [b] "r"(g_macsNr_b[i]),
                     [imm] "i"(g_macsNr_IMM));
...
void
check_macuNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macuNr_c[i])
                   : [a] "r"(g_macuNr_a[i]), [b] "r"(g_macuNr_b[i]),
                     [imm] "i"(g_macuNr_IMM));
...
void
check_macusNr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUSNR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macusNr_c[i])
                   : [a] "r"(g_macusNr_a[i]), [b] "r"(g_macusNr_b[i]),
                     [imm] "i"(g_macusNr_IMM));
...
void
check_macsNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACSNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macsNrR_c[i])
                   : [a] "r"(g_macsNrR_a[i]), [b] "r"(g_macsNrR_b[i]),
                     [imm] "i"(g_macsNrR_IMM));
...
void
check_macuNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macuNrR_c[i])
                   : [a] "r"(g_macuNrR_a[i]), [b] "r"(g_macuNrR_b[i]),
                     [imm] "i"(g_macuNrR_IMM));
...
void
check_macusNrR (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      asm volatile(MACUSNRR " %[c], %[a], %[b],%[imm]\n"
                   : [c] "+r"(g_macusNrR_c[i])
                   : [a] "r"(g_macusNrR_a[i]), [b] "r"(g_macusNrR_b[i]),
                     [imm] "i"(g_macusNrR_IMM));
