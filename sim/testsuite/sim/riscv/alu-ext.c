...
# output: == test: min -> success, nr. of errors: 0\n
# output: == test: max -> success, nr. of errors: 0\n
# output: == test: ror -> success, nr. of errors: 0\n
...
testcase_t testcases[] = {
  { .name = "min", .test = check_min }, { .name = "max", .test = check_max },
  { .name = "ror", .test = check_ror }, { .name = "abs", .test = check_abs },
  { .name = "ext", .test = check_ext }, { 0, 0 },
};
...
void
check_ror (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_min (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
...
void
check_max (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int act;
