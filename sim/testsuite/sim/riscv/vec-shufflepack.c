...
# output: == test: shuffle_h -> success, nr. of errors: 0\n
# output: == test: shuffle_b -> success, nr. of errors: 0\n
# output: == test: shuffle2_h -> success, nr. of errors: 0\n
# output: == test: shuffle2_b -> success, nr. of errors: 0\n
# output: == test: pack_h -> success, nr. of errors: 0\n
# output: == test: pack_hi_b -> success, nr. of errors: 0\n
# output: == test: pack_lo_b -> success, nr. of errors: 0\n
...
#include "bench.h"
#include "vec-shufflepack-stimuli.h"
...
void check_shuffle2_h (testresult_t *result, void (*start) (),
                       void (*stop) ());
void check_shuffle2_b (testresult_t *result, void (*start) (),
                       void (*stop) ());
...
testcase_t testcases[] = { { .name = "shuffle_h", .test = check_shuffle_h },
...
void
check_shuffle_h (testresult_t *result, void (*start) (), void (*stop) ())
{
...
void
check_shuffle_b (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int res = 0, i;
  ...
  shuffle_b_sci (g_shuffle_sci_b_a[0], g_shuffle_sci_b_0,
                 g_shuffle_sci_b_exp[0]);
  shuffle_b_sci (g_shuffle_sci_b_a[1], g_shuffle_sci_b_1,
                 g_shuffle_sci_b_exp[1]);
  shuffle_b_sci (g_shuffle_sci_b_a[2], g_shuffle_sci_b_2,
                 g_shuffle_sci_b_exp[2]);
  shuffle_b_sci (g_shuffle_sci_b_a[3], g_shuffle_sci_b_3,
                 g_shuffle_sci_b_exp[3]);
  shuffle_b_sci (g_shuffle_sci_b_a[4], g_shuffle_sci_b_4,
                 g_shuffle_sci_b_exp[4]);
  shuffle_b_sci (g_shuffle_sci_b_a[5], g_shuffle_sci_b_5,
                 g_shuffle_sci_b_exp[5]);
  shuffle_b_sci (g_shuffle_sci_b_a[6], g_shuffle_sci_b_6,
                 g_shuffle_sci_b_exp[6]);
  shuffle_b_sci (g_shuffle_sci_b_a[7], g_shuffle_sci_b_7,
                 g_shuffle_sci_b_exp[7]);
  shuffle_b_sci (g_shuffle_sci_b_a[8], g_shuffle_sci_b_8,
                 g_shuffle_sci_b_exp[8]);
  shuffle_b_sci (g_shuffle_sci_b_a[9], g_shuffle_sci_b_9,
                 g_shuffle_sci_b_exp[9]);
}
...
void
check_shuffle2_h (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      check_uint32 (result, "shuffle2_h", g_shuffle2_h_c[i],
                    g_shuffle2_h_exp[i]);
    }
}

void
check_shuffle2_b (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  ...
  for (i = 0; i < NumberOfStimuli; i++)
    {
      ...
      check_uint32 (result, "shuffle2_b", g_shuffle2_b_c[i],
                    g_shuffle2_b_exp[i]);
    }
}

void
check_pack_h (testresult_t *result, void (*start) (), void (*stop) ())
{
...
void
check_pack_hi_b (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
...
void
check_pack_lo_b (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
