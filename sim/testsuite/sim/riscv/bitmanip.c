...
# output: == test: bset -> success, nr. of errors: 0\n
# output: == test: bclr -> success, nr. of errors: 0\n
# output: == test: bextract -> success, nr. of errors: 0\n
# output: == test: bextractu -> success, nr. of errors: 0\n
# output: == test: binsert -> success, nr. of errors: 0\n
# output: == test: bset_reg -> success, nr. of errors: 0\n
# output: == test: bclr_reg -> success, nr. of errors: 0\n
# output: == test: bextract_reg -> success, nr. of errors: 0\n
# output: == test: bextractu_reg -> success, nr. of errors: 0\n
# output: == test: binsert_reg -> success, nr. of errors: 0\n
...
void check_bextract_reg (testresult_t *result, void (*start) (),
                         void (*stop) ());
void check_bextractu_reg (testresult_t *result, void (*start) (),
                          void (*stop) ());
void check_binsert_reg (testresult_t *result, void (*start) (),
                        void (*stop) ());
...
void
check_bset (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bclr (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bextract (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bextractu (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_binsert (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bset_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bclr_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bextract_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_bextractu_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
...
void
check_binsert_reg (testresult_t *result, void (*start) (), void (*stop) ())
{
  unsigned int i;
  unsigned int res;
