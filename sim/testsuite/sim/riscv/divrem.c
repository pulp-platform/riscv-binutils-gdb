...
# output: == test: div -> success, nr. of errors: 0\n
# output: == test: divu -> success, nr. of errors: 0\n
# output: == test: rem -> success, nr. of errors: 0\n
# output: == test: remu -> success, nr. of errors: 0\n
# output: == test: div_random -> success, nr. of errors: 0\n
# output: == test: divu_random -> success, nr. of errors: 0\n
# output: == test: rem_random -> success, nr. of errors: 0\n
# output: == test: remu_random -> success, nr. of errors: 0\n
...
void check_div_random (testresult_t *result, void (*start) (),
                       void (*stop) ());
void check_divu_random (testresult_t *result, void (*start) (),
                        void (*stop) ());
void check_rem_random (testresult_t *result, void (*start) (),
                       void (*stop) ());
void check_remu_random (testresult_t *result, void (*start) (),
                        void (*stop) ());
...
void
do_rem (testresult_t *result, int a, int b, int exp)
{
  int act;

  asm volatile("rem %[result], %[a], %[b]"
               : [result] "=r"(act)
               : [a] "r"(a), [b] "r"(b));
...
void
do_remu (testresult_t *result, unsigned int a, unsigned int b,
         unsigned int exp)
{
  unsigned int act;

  asm volatile("remu %[result], %[a], %[b]"
               : [result] "=r"(act)
               : [a] "r"(a), [b] "r"(b));
...
void
do_div (testresult_t *result, int a, int b, int exp)
{
  int act;

  asm volatile("div %[result], %[a], %[b]"
               : [result] "=r"(act)
               : [a] "r"(a), [b] "r"(b));
...
void
do_divu (testresult_t *result, unsigned int a, unsigned int b,
         unsigned int exp)
{
  unsigned int act;

  asm volatile("divu %[result], %[a], %[b]"
               : [result] "=r"(act)
               : [a] "r"(a), [b] "r"(b));
...
void
check_div_random (testresult_t *result, void (*start) (), void (*stop) ())
{
  int i;
...
void
check_divu_random (testresult_t *result, void (*start) (), void (*stop) ())
{
  int i;
...
void
check_rem_random (testresult_t *result, void (*start) (), void (*stop) ())
{
  int i;
...
void
check_remu_random (testresult_t *result, void (*start) (), void (*stop) ())
{
  int i;
